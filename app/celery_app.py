...
celery_app = Celery(
    ...
    include=["app.tasks.leaderboard", "app.tasks.billing", "app.tasks.notifications", "app.tasks.achievements", "app.tasks.achievement_processing", "app.tasks.content_moderation", "app.tasks.ai_analysis", "app.tasks.statistics"],
